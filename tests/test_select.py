"""Tests for the Astra Pool select platform."""
...
from custom_components.astra_pool.select import (
    AstraPoolChannelSelect,
    AstraPoolFavouriteSelect,
    AstraPoolSpaSelect,
    AstraPoolValveSelect,
)
...
def test_pool_spa_select_pool_mode(coordinator_mock, pool_id) -> None:
    ...
    entity = AstraPoolSpaSelect(coordinator_mock, pool_id)
...
def test_favourite_select_none_active(coordinator_mock, pool_id) -> None:
    ...
    entity = AstraPoolFavouriteSelect(coordinator_mock, pool_id, favourites)
...
def test_valve_select(coordinator_mock, pool_id) -> None:
    ...
    entity = AstraPoolValveSelect(coordinator_mock, pool_id, valve_cfg)
...
def test_channel_select_options(coordinator_mock, pool_id) -> None:
    ...
    entity = AstraPoolChannelSelect(coordinator_mock, pool_id, channel_cfg)
